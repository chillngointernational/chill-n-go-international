...
const CATEGORIES = [
  { name: 'Travel', icon: 'flight_takeoff', color: '#1D9E75', img: IMG.beach, sub: 'travel' },
  { name: 'Nutrition', icon: 'restaurant', color: '#e7c092', img: IMG.food, sub: 'nutrition' },
  { name: 'Store', icon: 'shopping_bag', color: '#FF7F50', img: IMG.accessories, sub: 'store' },
  { name: 'Online Store', icon: 'devices', color: '#c5c0ff', img: IMG.gadgets, sub: 'store' },
  { name: 'Real Estate', icon: 'domain', color: '#68dbae', img: IMG.mansion, sub: 'realestate' },
  { name: 'CandyStakes', icon: 'military_tech', color: '#8c84eb', img: IMG.bakery, sub: 'candystakes' },
]
